#!/bin/bash
# ============================================
# Check status of all ANPR Client Backend services
# ============================================
#
# USAGE:
#   ./scripts/status.sh
#
# DESCRIPTION:
#   Checks and displays the status of all services:
...
#
# NOTES:
#   - Script must be run from project root: ./scripts/status.sh
#   - Shows process IDs (PIDs) for running services
#   - Displays service URLs for easy access
#   - Performs API health check if curl is available
#
# ============================================
